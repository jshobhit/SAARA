...
void UpDown(){
   if (y > 600 && y_accel > -170){ 
    ...
    em1.step += 10;
    sm2.step += 5;
    if (em2.step >5180 && em2.step < 6219){
    hm1.write(pos);
    pos+= 0.3;
...
void hm1move()
{
  if (y > 600)
  {
    if (hm1Angle > 0 && hm1Angle < 180 || hm1Angle == 0){
    hm1Angle += 0.5;
    hm1.write(hm1Angle); 
  ...
  {
    if (hm1Angle > 0 && hm1Angle < 180 || hm1Angle == 180){
    hm1Angle -= 0.5; 
    hm1.write(hm1Angle);
    delayMicroseconds(900);  
    }
