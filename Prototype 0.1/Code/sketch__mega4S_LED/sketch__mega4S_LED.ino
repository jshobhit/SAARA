...
void setup() {
    ...
    pinMode(LED_SM1, OUTPUT);
    pinMode(LED_SM2, OUTPUT);
    pinMode(LED_EM1, OUTPUT);
}
...
void loop() {
    ...
    switch(motorID) {
        case 0 :
            digitalWrite(LED_SM1, HIGH);
            digitalWrite(LED_SM2, LOW);
            digitalWrite(LED_EM1, LOW);
            break;
        case 1 :
            digitalWrite(LED_SM1, LOW);
            digitalWrite(LED_SM2, HIGH);
            digitalWrite(LED_EM1, LOW);
            break;
        case 2 :
            digitalWrite(LED_SM1, LOW);
            digitalWrite(LED_SM2, LOW);
            digitalWrite(LED_EM1, HIGH);
            break;
    }
